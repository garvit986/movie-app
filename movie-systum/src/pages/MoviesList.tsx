...
import { Grid, Card, CardContent, CardMedia, List, ListItem, ListItemText, Typography, Button, Box } from '@mui/material';
import { loadMovies, addFavorite, removeFavorite } from '../redux/movieSlice';
...
const MoviesList: React.FC = () => {
    ...
    const { movies, loading, error, favorites } = useSelector((state: RootState) => state.movies);
